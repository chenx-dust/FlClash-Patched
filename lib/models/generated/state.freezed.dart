...
int get hashCode {
  final _this = this as SharedState;
  return Object.hash(runtimeType,_this.setupParams,_this.vpnOptions,_this.stopTip,_this.startTip,_this.currentProfileName,_this.stopText,_this.onlyStatisticsProxy,_this.networkSpeedNotification,_this.alwaysOn,const DeepCollectionEquality().hash(_this.excludeSSIDs));
}

@override
String toString() {
  final _this = this as SharedState;
  return 'SharedState(setupParams: ${_this.setupParams}, vpnOptions: ${_this.vpnOptions}, stopTip: ${_this.stopTip}, startTip: ${_this.startTip}, currentProfileName: ${_this.currentProfileName}, stopText: ${_this.stopText}, onlyStatisticsProxy: ${_this.onlyStatisticsProxy}, networkSpeedNotification: ${_this.networkSpeedNotification}, alwaysOn: ${_this.alwaysOn}, excludeSSIDs: ${_this.excludeSSIDs})';
}
...
class _SharedState implements SharedState {
  const _SharedState({this.setupParams, this.vpnOptions, required this.stopTip, required this.startTip, required this.currentProfileName, required this.stopText, required this.onlyStatisticsProxy, this.networkSpeedNotification = false, this.alwaysOn = false,  List<String> excludeSSIDs = const []}): _excludeSSIDs = excludeSSIDs;
...
@override
int get hashCode {
    return Object.hash(runtimeType,setupParams,vpnOptions,stopTip,startTip,currentProfileName,stopText,onlyStatisticsProxy,networkSpeedNotification,alwaysOn,const DeepCollectionEquality().hash(_excludeSSIDs));
}
