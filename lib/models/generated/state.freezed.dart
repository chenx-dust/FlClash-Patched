...
mixin _$AppBarSearchState {
 ...
 dynamic Function(String) get onSearch; dynamic Function(bool)? get onRegexChange; bool get autoAddSearch; bool get useRegex; String? get query;
...
int get hashCode {
  final _this = this as AppBarSearchState;
  return Object.hash(runtimeType,_this.onSearch,_this.onRegexChange,_this.autoAddSearch,_this.useRegex,_this.query);
}

@override
String toString() {
  final _this = this as AppBarSearchState;
  return 'AppBarSearchState(onSearch: ${_this.onSearch}, onRegexChange: ${_this.onRegexChange}, autoAddSearch: ${_this.autoAddSearch}, useRegex: ${_this.useRegex}, query: ${_this.query})';
}
...
@useResult
$Res call({
 dynamic Function(String) onSearch, dynamic Function(bool)? onRegexChange, bool autoAddSearch, bool useRegex, String? query
});
...
as dynamic Function(String),onRegexChange: freezed == onRegexChange ? _self.onRegexChange : onRegexChange // ignore: cast_nullable_to_non_nullable
as dynamic Function(bool)?,autoAddSearch: null == autoAddSearch ? _self.autoAddSearch : autoAddSearch // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( dynamic Function(String) onSearch,  dynamic Function(bool)? onRegexChange,  bool autoAddSearch,  bool useRegex,  String? query)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppBarSearchState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( dynamic Function(String) onSearch,  dynamic Function(bool)? onRegexChange,  bool autoAddSearch,  bool useRegex,  String? query)  $default,) {final _that = this;
switch (_that) {
case _AppBarSearchState():
return $default(_that.onSearch,_that.onRegexChange,_that.autoAddSearch,_that.useRegex,_that.query);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( dynamic Function(String) onSearch,  dynamic Function(bool)? onRegexChange,  bool autoAddSearch,  bool useRegex,  String? query)?  $default,) {final _that = this;
switch (_that) {
case _AppBarSearchState() when $default != null:
return $default(_that.onSearch,_that.onRegexChange,_that.autoAddSearch,_that.useRegex,_that.query);case _:
  return null;
...
@override final  dynamic Function(bool)? onRegexChange;
...
@override
int get hashCode {
    return Object.hash(runtimeType,onSearch,onRegexChange,autoAddSearch,useRegex,query);
}
...
int get hashCode {
  final _this = this as NetworkDetectionState;
  return Object.hash(runtimeType,_this.isLoading,_this.ipInfo,_this.isIpVisible);
}

@override
String toString() {
  final _this = this as NetworkDetectionState;
  return 'NetworkDetectionState(isLoading: ${_this.isLoading}, ipInfo: ${_this.ipInfo}, isIpVisible: ${_this.isIpVisible})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,isLoading,ipInfo,isIpVisible);
}
...
mixin _$SharedState {
 ...
 SetupParams? get setupParams; VpnOptions? get vpnOptions; String get stopTip; String get startTip; String get currentProfileName; String get stopText; bool get onlyStatisticsProxy; bool get networkSpeedNotification; bool get collapseQuickSettingsPanel; bool get alwaysOn; List<String> get excludeSSIDs;
...
int get hashCode {
  final _this = this as SharedState;
  return Object.hash(runtimeType,_this.setupParams,_this.vpnOptions,_this.stopTip,_this.startTip,_this.currentProfileName,_this.stopText,_this.onlyStatisticsProxy,_this.networkSpeedNotification,_this.collapseQuickSettingsPanel,_this.alwaysOn,const DeepCollectionEquality().hash(_this.excludeSSIDs));
}

@override
String toString() {
  final _this = this as SharedState;
  return 'SharedState(setupParams: ${_this.setupParams}, vpnOptions: ${_this.vpnOptions}, stopTip: ${_this.stopTip}, startTip: ${_this.startTip}, currentProfileName: ${_this.currentProfileName}, stopText: ${_this.stopText}, onlyStatisticsProxy: ${_this.onlyStatisticsProxy}, networkSpeedNotification: ${_this.networkSpeedNotification}, collapseQuickSettingsPanel: ${_this.collapseQuickSettingsPanel}, alwaysOn: ${_this.alwaysOn}, excludeSSIDs: ${_this.excludeSSIDs})';
}
...
@useResult
$Res call({
 SetupParams? setupParams, VpnOptions? vpnOptions, String stopTip, String startTip, String currentProfileName, String stopText, bool onlyStatisticsProxy, bool networkSpeedNotification, bool collapseQuickSettingsPanel, bool alwaysOn, List<String> excludeSSIDs
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SetupParams? setupParams,  VpnOptions? vpnOptions,  String stopTip,  String startTip,  String currentProfileName,  String stopText,  bool onlyStatisticsProxy,  bool networkSpeedNotification,  bool collapseQuickSettingsPanel,  bool alwaysOn,  List<String> excludeSSIDs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SharedState() when $default != null:
return $default(_that.setupParams,_that.vpnOptions,_that.stopTip,_that.startTip,_that.currentProfileName,_that.stopText,_that.onlyStatisticsProxy,_that.networkSpeedNotification,_that.collapseQuickSettingsPanel,_that.alwaysOn,_that.excludeSSIDs);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SetupParams? setupParams,  VpnOptions? vpnOptions,  String stopTip,  String startTip,  String currentProfileName,  String stopText,  bool onlyStatisticsProxy,  bool networkSpeedNotification,  bool collapseQuickSettingsPanel,  bool alwaysOn,  List<String> excludeSSIDs)  $default,) {final _that = this;
switch (_that) {
case _SharedState():
return $default(_that.setupParams,_that.vpnOptions,_that.stopTip,_that.startTip,_that.currentProfileName,_that.stopText,_that.onlyStatisticsProxy,_that.networkSpeedNotification,_that.collapseQuickSettingsPanel,_that.alwaysOn,_that.excludeSSIDs);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SetupParams? setupParams,  VpnOptions? vpnOptions,  String stopTip,  String startTip,  String currentProfileName,  String stopText,  bool onlyStatisticsProxy,  bool networkSpeedNotification,  bool collapseQuickSettingsPanel,  bool alwaysOn,  List<String> excludeSSIDs)?  $default,) {final _that = this;
switch (_that) {
case _SharedState() when $default != null:
return $default(_that.setupParams,_that.vpnOptions,_that.stopTip,_that.startTip,_that.currentProfileName,_that.stopText,_that.onlyStatisticsProxy,_that.networkSpeedNotification,_that.collapseQuickSettingsPanel,_that.alwaysOn,_that.excludeSSIDs);case _:
  return null;
...
class _SharedState implements SharedState {
  const _SharedState({this.setupParams, this.vpnOptions, required this.stopTip, required this.startTip, required this.currentProfileName, required this.stopText, required this.onlyStatisticsProxy, this.networkSpeedNotification = false, this.collapseQuickSettingsPanel = true, this.alwaysOn = false,  List<String> excludeSSIDs = const []}): _excludeSSIDs = excludeSSIDs;
