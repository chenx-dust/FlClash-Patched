...
mixin _$AppSettingProps {
 ...
 String? get locale;@JsonKey(fromJson: dashboardWidgetsSafeFormJson) List<DashboardWidget> get dashboardWidgets; bool get onlyStatisticsProxy; bool get autoLaunch; bool get highPriorityAutoLaunch; bool get silentLaunch; bool get autoRun; bool get openLogs; bool get closeConnections; bool get promptCloseConnections; String get testUrl; bool get isAnimateToPage; bool get isSwipeToPage; bool get autoCheckUpdate; bool get showLabel; bool get disclaimerAccepted; bool get minimizeOnExit; bool get hidden; bool get collapseQuickSettingsPanel; bool get developerMode;@JsonKey(unknownEnumValue: RestoreStrategy.compatible) RestoreStrategy get restoreStrategy; bool get checkCertificate; String get customUserAgent; int get foregroundTickerInterval; bool get foregroundTickerIdleWhenUnfocused; int get foregroundTickerIdleInterval;
...
int get hashCode {
  final _this = this as AppSettingProps;
  return Object.hashAll([runtimeType,_this.locale,const DeepCollectionEquality().hash(_this.dashboardWidgets),_this.onlyStatisticsProxy,_this.autoLaunch,_this.highPriorityAutoLaunch,_this.silentLaunch,_this.autoRun,_this.openLogs,_this.closeConnections,_this.promptCloseConnections,_this.testUrl,_this.isAnimateToPage,_this.isSwipeToPage,_this.autoCheckUpdate,_this.showLabel,_this.disclaimerAccepted,_this.minimizeOnExit,_this.hidden,_this.collapseQuickSettingsPanel,_this.developerMode,_this.restoreStrategy,_this.checkCertificate,_this.customUserAgent,_this.foregroundTickerInterval,_this.foregroundTickerIdleWhenUnfocused,_this.foregroundTickerIdleInterval]);
}

@override
String toString() {
  final _this = this as AppSettingProps;
  return 'AppSettingProps(locale: ${_this.locale}, dashboardWidgets: ${_this.dashboardWidgets}, onlyStatisticsProxy: ${_this.onlyStatisticsProxy}, autoLaunch: ${_this.autoLaunch}, highPriorityAutoLaunch: ${_this.highPriorityAutoLaunch}, silentLaunch: ${_this.silentLaunch}, autoRun: ${_this.autoRun}, openLogs: ${_this.openLogs}, closeConnections: ${_this.closeConnections}, promptCloseConnections: ${_this.promptCloseConnections}, testUrl: ${_this.testUrl}, isAnimateToPage: ${_this.isAnimateToPage}, isSwipeToPage: ${_this.isSwipeToPage}, autoCheckUpdate: ${_this.autoCheckUpdate}, showLabel: ${_this.showLabel}, disclaimerAccepted: ${_this.disclaimerAccepted}, minimizeOnExit: ${_this.minimizeOnExit}, hidden: ${_this.hidden}, collapseQuickSettingsPanel: ${_this.collapseQuickSettingsPanel}, developerMode: ${_this.developerMode}, restoreStrategy: ${_this.restoreStrategy}, checkCertificate: ${_this.checkCertificate}, customUserAgent: ${_this.customUserAgent}, foregroundTickerInterval: ${_this.foregroundTickerInterval}, foregroundTickerIdleWhenUnfocused: ${_this.foregroundTickerIdleWhenUnfocused}, foregroundTickerIdleInterval: ${_this.foregroundTickerIdleInterval})';
}
...
@useResult
$Res call({
 String? locale,@JsonKey(fromJson: dashboardWidgetsSafeFormJson) List<DashboardWidget> dashboardWidgets, bool onlyStatisticsProxy, bool autoLaunch, bool highPriorityAutoLaunch, bool silentLaunch, bool autoRun, bool openLogs, bool closeConnections, bool promptCloseConnections, String testUrl, bool isAnimateToPage, bool isSwipeToPage, bool autoCheckUpdate, bool showLabel, bool disclaimerAccepted, bool minimizeOnExit, bool hidden, bool collapseQuickSettingsPanel, bool developerMode,@JsonKey(unknownEnumValue: RestoreStrategy.compatible) RestoreStrategy restoreStrategy, bool checkCertificate, String customUserAgent, int foregroundTickerInterval, bool foregroundTickerIdleWhenUnfocused, int foregroundTickerIdleInterval
});
...
/// Create a copy of AppSettingProps
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? locale = freezed,Object? dashboardWidgets = null,Object? onlyStatisticsProxy = null,Object? autoLaunch = null,Object? highPriorityAutoLaunch = null,Object? silentLaunch = null,Object? autoRun = null,Object? openLogs = null,Object? closeConnections = null,Object? promptCloseConnections = null,Object? testUrl = null,Object? isAnimateToPage = null,Object? isSwipeToPage = null,Object? autoCheckUpdate = null,Object? showLabel = null,Object? disclaimerAccepted = null,Object? minimizeOnExit = null,Object? hidden = null,Object? collapseQuickSettingsPanel = null,Object? developerMode = null,Object? restoreStrategy = null,Object? checkCertificate = null,Object? customUserAgent = null,Object? foregroundTickerInterval = null,Object? foregroundTickerIdleWhenUnfocused = null,Object? foregroundTickerIdleInterval = null,}) {
...
switch (_that) {
case _AppSettingProps() when $default != null:
return $default(_that.locale,_that.dashboardWidgets,_that.onlyStatisticsProxy,_that.autoLaunch,_that.highPriorityAutoLaunch,_that.silentLaunch,_that.autoRun,_that.openLogs,_that.closeConnections,_that.promptCloseConnections,_that.testUrl,_that.isAnimateToPage,_that.isSwipeToPage,_that.autoCheckUpdate,_that.showLabel,_that.disclaimerAccepted,_that.minimizeOnExit,_that.hidden,_that.collapseQuickSettingsPanel,_that.developerMode,_that.restoreStrategy,_that.checkCertificate,_that.customUserAgent,_that.foregroundTickerInterval,_that.foregroundTickerIdleWhenUnfocused,_that.foregroundTickerIdleInterval);case _:
  return orElse();
...
class _AppSettingProps implements AppSettingProps {
  const _AppSettingProps({this.locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson)  List<DashboardWidget> dashboardWidgets = defaultDashboardWidgets, this.onlyStatisticsProxy = false, this.autoLaunch = false, this.highPriorityAutoLaunch = false, this.silentLaunch = false, this.autoRun = false, this.openLogs = false, this.closeConnections = false, this.promptCloseConnections = true, this.testUrl = defaultTestUrl, this.isAnimateToPage = true, this.isSwipeToPage = true, this.autoCheckUpdate = true, this.showLabel = false, this.disclaimerAccepted = false, this.minimizeOnExit = true, this.hidden = false, this.collapseQuickSettingsPanel = true, this.developerMode = false, @JsonKey(unknownEnumValue: RestoreStrategy.compatible) this.restoreStrategy = RestoreStrategy.compatible, this.checkCertificate = true, this.customUserAgent = '', this.foregroundTickerInterval = defaultForegroundTickerInterval, this.foregroundTickerIdleWhenUnfocused = true, this.foregroundTickerIdleInterval = defaultForegroundTickerIdleInterval}): _dashboardWidgets = dashboardWidgets;
...
class _NetworkProps implements NetworkProps {
  const _NetworkProps({this.systemProxy = true,  List<String> bypassDomain = defaultBypassDomain, @JsonKey(unknownEnumValue: RouteMode.config) this.routeMode = RouteMode.config, this.autoSetSystemDns = true, this.appendSystemDns = false}): _bypassDomain = bypassDomain;
...
@override
int get hashCode {
    return Object.hash(runtimeType,currentProfileId,overrideDns,const DeepCollectionEquality().hash(_hotKeyActions),appSettingProps,davProps,networkProps,vpnProps,themeProps,proxiesStyleProps,windowProps,patchClashConfig,const DeepCollectionEquality().hash(_excludeSSIDs),alwaysOn);
}
