...
@ProviderFor(DavPassword)
final davPasswordProvider = DavPasswordProvider._();

final class DavPasswordProvider extends $NotifierProvider<DavPassword, String> {
  DavPasswordProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'davPasswordProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$davPasswordHash();

  @$internal
  @override
  DavPassword create() => DavPassword();
...
String _$davPasswordHash() => r'd7ce8bf10688ec48b9cc074d17a4f8ddd9bdad62';

abstract class _$DavPassword extends $Notifier<String> {
  String build();
  @$mustCallSuper
  @override
...
String _$requestsHash() => r'694abfcdb3d98716fbeec350562965f733d41bbb';
...
String _$networkDetectionHash() => r'bb68a546a2faff3edee48064f3e9df177d67f35c';
