...
const iosBundleIdentifier = String.fromEnvironment(
  'IOS_BUNDLE_ID',
  defaultValue: 'com.follow.clash',
);
const appGroupIdentifier = 'group.$iosBundleIdentifier';
