...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(subRule) => "${subRule} 是一个无效的 SUB_RULE";
  ...
  static String m22(label) => "${label} 必须在 1024 到 49151 之间，0 为禁用";

  static String m23(count) => "${count} 个代理";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "locationPermissionDesc": MessageLookupByLibrary.simpleMessage(
      "根据系统要求，获取 Wi-Fi 名称需要您授予位置权限。Android 上请选择“始终允许”，否则应用在后台时无法获取 Wi-Fi 名称。",
    ),
